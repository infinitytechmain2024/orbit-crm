...
const researchAgent = new Agent({
  instructions:
    "Research about artificial intelligence and its impact on society. Focus on current trends and future predictions.",
  name: "Researcher",
  verbose: true,
  pretty: true,
});
...
const summarizeAgent = new Agent({
  instructions:
    "Create a concise summary of the research findings. Highlight key points and potential implications.",
  name: "Summarizer",
  verbose: true,
  pretty: true,
});
