...
3. **ASK about social profiles first** (skip only if the user already said yes/no): _"Also grab social profiles
   (Instagram / Facebook / LinkedIn) for these? Emails are already included. (yes / no)"_ — if yes, add `--socials`.
