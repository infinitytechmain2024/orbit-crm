...
DEFAULT_DEPARTMENTS = (
    {"name": "CEO", "color": "#f59e0b", "icon": "user-round"},
    {"name": "Chief of Development Department", "color": "#23c7f4", "icon": "code-2"},
    {"name": "Chief Marketing Operation", "color": "#19d3c5", "icon": "megaphone"},
    {"name": "HR", "color": "#8b7cf6", "icon": "users-round"},
)

DEFAULT_AGENTS = (
    ("CEO", "CEO", "Chief Executive Officer", ("reasoning", "long_context")),
    ("Chief of Development Department", "Frontend", "Интерфейсы, компоненты, UX и адаптивность", ("coding", "reasoning", "vision")),
    ("Chief of Development Department", "Backend", "API, серверная логика, база данных и авторизация", ("coding", "reasoning", "long_context")),
    ("Chief of Development Department", "QA / DevOps", "Тесты, CI/CD, деплой и мониторинг", ("coding", "analysis", "fast")),
    ("Chief of Development Department", "AI Integrations", "Модели, промпты, инструменты и AI-пайплайны", ("coding", "reasoning", "long_context")),
    ("Chief Marketing Operation", "CMO", "Стратегия, позиционирование и планы роста", ("writing", "analysis", "reasoning")),
    ("Chief Marketing Operation", "Sales Rep", "Лиды, предложения и продажи", ("writing", "analysis", "fast")),
    ("Chief Marketing Operation", "SEO", "Семантика, метаданные и контент-планы", ("writing", "analysis", "reasoning")),
    ("Chief Marketing Operation", "SMM", "Социальные сети, контент и публикации", ("writing", "analysis", "fast")),
    ("Chief Marketing Operation", "Рассылка", "Email-цепочки, сегментация и письма", ("writing", "analysis", "fast")),
    ("Chief Marketing Operation", "Парсинг", "Поиск и сбор структурированных данных", ("analysis", "fast", "long_context")),
    ("Chief Marketing Operation", "Data Analyst", "Аналитика, отчёты и KPI", ("analysis", "reasoning", "long_context")),
