...
const DataValueMapItemSchema = lazyType(() =>
  objectType({
    key: stringType(),
  ...
  return DataValueMapItemSchema.superRefine((val, ctx) => {
    const checkDepth = (v, currentDepth) => {
      ...
      if (v.valueMap && Array.isArray(v.valueMap))
        for (const item of v.valueMap) checkDepth(item, currentDepth + 1);
    };
    checkDepth(val, 1);
  });
}
...
const TextSchema = objectType({
  ...
  usageHint: enumType(["h1", "h2", "h3", "h4", "h5", "caption", "body"]).optional(),
});
const ImageSchema = objectType({
  ...
  fit: enumType(["contain", "cover", "fill", "none", "scale-down"]).optional(),
...
const ModalSchema = objectType({
  entryPointChild: stringType().describe(
...
const TextFieldSchema = objectType({
  ...
  textFieldType: enumType(["shortText", "number", "date", "longText", "obscured"]).optional(),
...
const RowSchema = objectType({
  ...
  alignment: enumType(["start", "center", "end", "stretch"]).optional(),
});
...
const CardSchema = objectType({
  child: stringType().describe("The ID of the component to be rendered inside the card."),
});
const ValueMapSchema = DataValueSchema.describe(
...
const SurfaceUpdateMessageSchema = objectType({
  ...
  components: arrayType(ComponentInstanceSchema)
    .min(1)
...
const DataModelUpdateMessageSchema = objectType({
  ...
  contents: arrayType(ValueMapSchema).describe(
...
const DeleteSurfaceMessageSchema = objectType({
  surfaceId: stringType().describe("The unique identifier for the UI surface to be deleted."),
})
  .strict()
...
var A2uiMessageProcessor = class A2uiMessageProcessor {
  ...
  getSurfaces() {
    ...
    for (const [surfaceId, surface] of allSurfaces)
      if (surface.rootComponentId) visibleSurfaces.set(surfaceId, surface);
...
const t$7 = globalThis,
  e$13 =
    t$7.ShadowRoot &&
    (void 0 === t$7.ShadyCSS || t$7.ShadyCSS.nativeShadow) &&
 ...
 */ const {
    is: i$9,
    defineProperty: e$12,
    getOwnPropertyDescriptor: h$7,
    getOwnPropertyNames: r$10,
    getOwnPropertySymbols: o$13,
    getPrototypeOf: n$12,
  } = Object,
  a$1 = globalThis,
  c$6 = a$1.trustedTypes,
  l$4 = c$6 ? c$6.emptyScript : "",
...
const t$6 = globalThis,
  i$8 = (t) => t,
  s$8 = t$6.trustedTypes,
  e$11 = s$8 ? s$8.createPolicy("lit-html", { createHTML: (t) => t }) : void 0,
  h$6 = "$lit$",
  ...
  for (let i = 0; i < s; i++) {
    ...
    l +=
      c === v$1
        ? s + r$9
        : d >= 0
          ? (e.push(a), s.slice(0, d) + h$6 + s.slice(d) + o$12 + x)
          : s + o$12 + (-2 === d ? i : x);
  }
...
var k = class k {
  ...
  k(t) {
    ...
    for (const h of t)
      (e === i.length
        ? i.push((s = new k(this.O(c$5()), this.O(c$5()), this, this.options)))
        : (s = i[e]),
        s._$AI(h),
        e++);
...
((i$7._$litElement$ = !0),
  (i$7["finalized"] = !0),
  s$7.litElementHydrateSupport?.({ LitElement: i$7 }));
...
const s$6 = new Signal.subtle.Watcher(() => {
  ...
  h$5 = Symbol("SignalWatcherBrand"),
  e$7 = new FinalizationRegistry((i) => {
 ...
 */ const { I: t$2 } = j$1,
  i$4 = (o) => o,
  n$6 = (o) => null === o || ("object" != typeof o && "function" != typeof o),
  r$4 = (o) => void 0 === o.strings,
...
function n$5(i, t = !1, e = 0) {
  ...
  if (void 0 !== h && 0 !== h.size)
    if (t)
      if (Array.isArray(r)) for (let i = e; i < r.length; i++) (s$4(r[i], !1), o$6(r[i]));
    ...
    (super(void 0 !== e.context ? e.initialValue : i),
      ...
      (this.onProviderRequest = (s) => {
        ...
        for (const [s, { consumerHost: i }] of this.subscriptions)
          e.has(s) || (e.add(s), i.dispatchEvent(new s$3(this.context, i, s, !0)));
        s.stopPropagation();
      }),
      (this.host = s),
      ...
      update(e, [r]) {
        ...
        for (const t in r) {
          ...
          if (null != e) {
            ...
            t.includes("-") || r
              ? s.setProperty(t, r ? e.slice(0, -11) : e, r ? n$2 : "")
              : (s[t] = e);
          }
        }
        return E;
  ...
  var Button = class extends _classSuper {
    ...
    static {
      ...
      __esDecorate$17(
        ...
        _primary_initializers,
        _primary_extraInitializers,
      );
      __esDecorate$17(
        null,
        (_classDescriptor = { value: _classThis }),
    ...
    #primary_accessor_storage =
      (__runInitializers$17(this, _action_extraInitializers),
      __runInitializers$17(this, _primary_initializers, false));
    get primary() {
  ...
  var Image = class extends _classSuper {
    ...
    static {
      ...
      __esDecorate$10(
        ...
        _altText_initializers,
        _altText_extraInitializers,
      );
      __esDecorate$10(
        this,
        null,
    ...
    #altText_accessor_storage =
      (__runInitializers$10(this, _url_extraInitializers),
      __runInitializers$10(this, _altText_initializers, null));
    get altText() {
    ...
    #usageHint_accessor_storage =
      (__runInitializers$10(this, _altText_extraInitializers),
  ...
  var MultipleChoice = class extends _classSuper {
    ...
    static {
      ...
      __esDecorate$8(
        ...
        _variant_initializers,
        _variant_extraInitializers,
      );
      __esDecorate$8(
        this,
        null,
        _filterable_decorators,
        {
          kind: "accessor",
          name: "filterable",
          static: false,
        ...
        _filterable_initializers,
        _filterable_extraInitializers,
      );
      __esDecorate$8(
        this,
        null,
        ...
        _isOpen_initializers,
        _isOpen_extraInitializers,
      );
      __esDecorate$8(
        this,
        null,
        _filterText_decorators,
        {
          kind: "accessor",
          name: "filterText",
          static: false,
        ...
        _filterText_initializers,
        _filterText_extraInitializers,
      );
      __esDecorate$8(
        null,
        (_classDescriptor = { value: _classThis }),
    ...
    #variant_accessor_storage =
      ...
      __runInitializers$8(this, _variant_initializers, "checkbox"));
    get variant() {
    ...
    #filterable_accessor_storage =
      (__runInitializers$8(this, _variant_extraInitializers),
      __runInitializers$8(this, _filterable_initializers, false));
    get filterable() {
    ...
    #isOpen_accessor_storage =
      (__runInitializers$8(this, _filterable_extraInitializers),
      __runInitializers$8(this, _isOpen_initializers, false));
    get isOpen() {
    ...
    #filterText_accessor_storage =
      (__runInitializers$8(this, _isOpen_extraInitializers),
      __runInitializers$8(this, _filterText_initializers, ""));
    get filterText() {
    ...
    render() {
      ...
      const filteredOptions = this.options.filter((option) => {
        ...
        return extractStringValue(option.label, this.component, this.processor, this.surfaceId)
          .toLowerCase()
...
(() => {
  ...
  var Slider = class extends _classSuper {
    ...
    #renderField(value) {
      ...
      ${
        this.label
          ? b`<label class=${e$2(this.theme.components.Slider.label)} for="data">
...
(() => {
  ...
  var Surface = class extends _classSuper {
    ...
    #renderLogo() {
      ...
      __runInitializers$4(this, _enableCustomElements_initializers, false));
    get enableCustomElements() {
      return this.#enableCustomElements_accessor_storage;
    }
    set enableCustomElements(value) {
  ...
  var TextField = class extends _classSuper {
    ...
    static {
      ...
      __esDecorate$2(
        ...
        _textFieldType_initializers,
        _textFieldType_extraInitializers,
      );
      __esDecorate$2(
        this,
        null,
        _validationRegexp_decorators,
        {
          kind: "accessor",
        ...
        _validationRegexp_initializers,
        _validationRegexp_extraInitializers,
      );
      __esDecorate$2(
        null,
        (_classDescriptor = { value: _classThis }),
    ...
    #textFieldType_accessor_storage =
      (__runInitializers$2(this, _label_extraInitializers),
      __runInitializers$2(this, _textFieldType_initializers, null));
    get textFieldType() {
    ...
    #validationRegexp_accessor_storage =
      (__runInitializers$2(this, _textFieldType_extraInitializers),
      __runInitializers$2(this, _validationRegexp_initializers, null));
    ...
    #renderField(value, label) {
      ...
      ${
        label && label !== ""
          ? b`<label class=${e$2(this.theme.components.TextField.label)} for="data"
            >${label}</label
          >`
          : A
      }
 ...
 */ var e = class extends i$5 {
  constructor(i) {
    if ((super(i), (this.it = A), i.type !== t$3.CHILD))
...
const m = e$6(c);
const markdown$1 = e$6(
  class MarkdownDirective extends i$5 {
    #lastValue = null;
  ...
  var Text = class extends _classSuper {
    ...
    static {
      ...
      __esDecorate$1(
        ...
        _markdownRenderer_initializers,
        _markdownRenderer_extraInitializers,
      );
      __esDecorate$1(
        null,
        (_classDescriptor = { value: _classThis }),
    ...
    #markdownRenderer_accessor_storage =
      (__runInitializers$1(this, _usageHint_extraInitializers),
      __runInitializers$1(this, _markdownRenderer_initializers, void 0));
    ...
    #renderText() {
      ...
      return b`${markdown$1(markdownText, this.markdownRenderer, {
        tagClassMap: appendToAll(this.theme.markdown, ["ol", "ul", "li"], {}),
      })}`;
    }
...
var OpenClawA2UIHost = class extends i$7 {
  ...
  render() {
    ...
    return b` ${
      ...
      ${
        this.toast
          ? b`<div class="toast ${this.toast.kind === "error" ? "error" : ""}">
            ${this.toast.text}
          </div>`
          : ""
      }
