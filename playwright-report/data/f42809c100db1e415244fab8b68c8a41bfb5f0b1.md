...
- Name: approval-workflow.spec.ts >> AI-CEO Approval Workflow >> should display CEO Dashboard and Approval Gateway
- Location: e2e/approval-workflow.spec.ts:15:3
...
Locator: locator('text=CEO Dashboard')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=CEO Dashboard')

```

```yaml
- text: Восстанавливаю сессию…
```
